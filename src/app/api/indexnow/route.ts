...
export async function GET() {
  try {
    const urls: string[] = [
      ...
      `${SITE_URL}/services/`,
      `${SITE_URL}/services/hire-seo-expert/`,
      `${SITE_URL}/services/wordpress-development/`,
      ...
      `${SITE_URL}/seo-expert-mumbai/`,
      `${SITE_URL}/seo-expert-bangalore/`,
      `${SITE_URL}/seo-expert-hyderabad/`,
      `${SITE_URL}/seo-expert-chennai/`,
      `${SITE_URL}/seo-expert-pune/`,
      `${SITE_URL}/seo-expert-kolkata/`,
      `${SITE_URL}/international-seo-expert/`,
