...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const servicePages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/services/hire-seo-expert/`, priority: 0.97 },
    { url: `${SITE_URL}/services/wordpress-development/`, priority: 0.95 },
    { url: `${SITE_URL}/services/seo/`, priority: 0.9 },
    { url: `${SITE_URL}/services/white-hat-seo/`, priority: 0.92 },
    ...
    { url: `${SITE_URL}/services/digital-marketing/`, priority: 0.9 },
  ...
  const locationPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/seo-expert-mumbai/`, priority: 0.9 },
    { url: `${SITE_URL}/seo-expert-bangalore/`, priority: 0.9 },
    { url: `${SITE_URL}/seo-expert-hyderabad/`, priority: 0.88 },
    { url: `${SITE_URL}/seo-expert-chennai/`, priority: 0.88 },
    { url: `${SITE_URL}/seo-expert-pune/`, priority: 0.88 },
    { url: `${SITE_URL}/seo-expert-kolkata/`, priority: 0.88 },
    { url: `${SITE_URL}/international-seo-expert/`, priority: 0.92 },
  ].map((l) => ({
    ...l,
    lastModified: TODAY,
    changeFrequency: "monthly" as const,
