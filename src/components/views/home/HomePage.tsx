            ...
            <div className="card-3d-interactive p-5 sm:p-8 space-y-5 sm:space-y-6 shadow-2xl h-full flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-sm leading-relaxed text-white/75">
                  I&apos;m Rohit Gupta — a freelance web developer and SEO specialist working from Noida, with roots in Ayodhya. For the last couple of years I&apos;ve helped 200+ businesses — small salons and coaching institutes in Noida, startups in Mumbai, SaaS brands in Bengaluru, even eCommerce stores in the UK and US — get found, load fast, and actually convert. The thing that makes me a little different is that I&apos;m both the strategist and the person writing the code. I don&apos;t just tell you your Core Web Vitals are broken; I fix them. I don&apos;t just plan keyword clusters; I build the schema that powers them. I work hands-on with clients across India and worldwide, and I&apos;m just as happy meeting you in person across Delhi NCR and Ayodhya as I am working 100% remote, wherever you are.
                </p>
              </div>
